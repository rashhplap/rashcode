# rashcode for Non-Technical Users
...
rashcode lets you use an AI coding assistant with different model providers such as:
...
After you run `rashcode`, the CLI should start and wait for your prompt.
