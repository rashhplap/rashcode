...
import { clearMemoryFileCaches, getMemoryFiles } from '../../utils/rashmd.js';
...
function MemoryCommand({
  ...
  const handleSelectMemoryFile = async (memoryPath: string) => {
    try {
      // Create rash directory if it doesn't exist (idempotent with recursive)
      if (memoryPath.includes(getRashConfigHomeDir())) {
        await mkdir(getRashConfigHomeDir(), {
          recursive: true
        });
      }
  ...
  return <Dialog title="Memory" onCancel={handleCancel} color="remember">
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          <Text dimColor>
            Learn more: <Link url="https://code.rash.com/docs/en/memory" />
          </Text>
        </Box>
      </Box>
    </Dialog>;
