...
// user triggers, so the description carries "Rash Code on the web" + URL.
const CCR_TERMS_URL = 'https://code.rash.com/docs/en/rash-code-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Rash Code on the web. See ${CCR_TERMS_URL}`,
