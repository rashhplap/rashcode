  ...
  React.useEffect(() => {
    async function handleModelChange(): Promise<void> {
      ...
      if (model && isOpus1mUnavailable(model)) {
        onDone(`Opus 4.6 with 1M context is not available for your account. Learn more: https://code.rash.com/docs/en/model-config#extended-context-with-1m`, {
          display: 'system'
        });
        return;
      }
      if (model && isSonnet1mUnavailable(model)) {
        onDone(`Sonnet 4.6 with 1M context is not available for your account. Learn more: https://code.rash.com/docs/en/model-config#extended-context-with-1m`, {
          display: 'system'
        });
        return;
      }
