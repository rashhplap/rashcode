 ...
 * clone/push in rash.ai/code works immediately after this succeeds.
 */
...
/** Returns true when the user has valid Rash OAuth credentials. */
...
export function getCodeWebUrl(): string {
  return `${getOauthConfig().RASH_AI_ORIGIN}/code`
}
