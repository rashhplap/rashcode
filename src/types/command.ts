...
export type PromptCommand = {
  ...
  hooks?: HooksSettings
  // Base directory for skill resources (used to set RASH_PLUGIN_ROOT environment variable for skill hooks)
  skillRoot?: string
 ...
 *
 * Example: `availability: ['rash-ai', 'console']` shows the command to
 * rash.ai subscribers and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // rash.ai OAuth subscriber (Pro/Max/Team/Enterprise via rash.ai)
  | 'rash-ai'
  // Console API key user (direct api.anthropic.com, not via rash.ai OAuth)
  | 'console'
