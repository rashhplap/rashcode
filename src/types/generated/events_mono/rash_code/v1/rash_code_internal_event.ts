...
//   protoc               unknown
// source: events_mono/rash_code/v1/rash_code_internal_event.proto
 ...
 * See rash-cli-internal/src/services/statsig.ts for the source of these fields
 */
export interface EnvironmentMetadata {
  ...
  is_rash_code_action?: boolean | undefined
  is_rash_ai_auth?: boolean | undefined
  ...
  is_rash_code_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  rash_code_container_id?: string | undefined
  rash_code_remote_session_id?: string | undefined
...
/**
 * SlackContext contains context fields present on every Rash-in-Slack (CIS) event.
 * Event-specific fields (errorType, durationMs, httpStatus, etc.) go in
 * RashCodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * RashCodeInternalEvent represents events logged from Rash Code via Statsig
 * This schema matches the structure in rash-cli-internal/src/services/statsig.ts
 * Source table: proj-product-data-nhme.raw_statsig_internal_tools.events
 */
export interface RashCodeInternalEvent {
  ...
  /** Rash-in-Slack context (only present for cis_* events) */
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    is_rash_code_action: false,
    is_rash_ai_auth: false,
    version: '',
    github_event_name: '',
    ...
    arch: '',
    is_rash_code_remote: false,
    remote_environment_type: '',
    rash_code_container_id: '',
    rash_code_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_rash_code_action: isSet(object.is_rash_code_action)
        ? globalThis.Boolean(object.is_rash_code_action)
        : false,
      is_rash_ai_auth: isSet(object.is_rash_ai_auth)
        ? globalThis.Boolean(object.is_rash_ai_auth)
        : false,
      ...
      is_rash_code_remote: isSet(object.is_rash_code_remote)
        ? globalThis.Boolean(object.is_rash_code_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      rash_code_container_id: isSet(object.rash_code_container_id)
        ? globalThis.String(object.rash_code_container_id)
        : '',
      rash_code_remote_session_id: isSet(object.rash_code_remote_session_id)
        ? globalThis.String(object.rash_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_rash_code_action !== undefined) {
      obj.is_rash_code_action = message.is_rash_code_action
    }
    if (message.is_rash_ai_auth !== undefined) {
      obj.is_rash_ai_auth = message.is_rash_ai_auth
    }
    ...
    if (message.is_rash_code_remote !== undefined) {
      obj.is_rash_code_remote = message.is_rash_code_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.rash_code_container_id !== undefined) {
      obj.rash_code_container_id = message.rash_code_container_id
    }
    if (message.rash_code_remote_session_id !== undefined) {
      obj.rash_code_remote_session_id = message.rash_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_rash_code_action = object.is_rash_code_action ?? false
    message.is_rash_ai_auth = object.is_rash_ai_auth ?? false
    ...
    message.is_rash_code_remote = object.is_rash_code_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.rash_code_container_id = object.rash_code_container_id ?? ''
    message.rash_code_remote_session_id =
      object.rash_code_remote_session_id ?? ''
...
function createBaseRashCodeInternalEvent(): RashCodeInternalEvent {
  return {
    event_name: '',
...
export const RashCodeInternalEvent: MessageFns<RashCodeInternalEvent> = {
  fromJSON(object: any): RashCodeInternalEvent {
    return {
  ...
  toJSON(message: RashCodeInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<RashCodeInternalEvent>, I>>(
    base?: I,
  ): RashCodeInternalEvent {
    return RashCodeInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<RashCodeInternalEvent>, I>>(
    object: I,
  ): RashCodeInternalEvent {
    const message = createBaseRashCodeInternalEvent()
