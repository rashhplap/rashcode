...
- Ask where the skill should be saved. Suggest a default based on context (repo-specific workflows → repo, cross-repo personal workflows → user). Options:
  - **This repo** (\`.rash/skills/<name>/SKILL.md\`) — for workflows specific to this project
  - **Personal** (\`~/.rash/skills/<name>/SKILL.md\`) — follows you across all repos
...
when_to_use: {{detailed description of when Rash should automatically invoke this skill, including trigger phrases and example user messages}}
