...
- Information already in RASH.md or other project docs
 ...
 * Custom prompts can be placed at ~/.rash/magic-docs/prompt.md
...
async function loadMagicDocsPrompt(): Promise<string> {
  ...
  const promptPath = join(getRashConfigHomeDir(), 'magic-docs', 'prompt.md')
