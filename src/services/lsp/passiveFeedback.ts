...
/**
 * Map LSP severity to Rash diagnostic severity
 *
 * Maps LSP severity numbers to Rash diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Rash diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Rash's attachment system.
 */
 ...
 * from all LSP servers and routes them to Rash's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Rash format (can throw on invalid URIs)
