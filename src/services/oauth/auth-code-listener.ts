...
import { shouldUseRashAIAuth } from './client.js'
...
export class AuthCodeListener {
  ...
  handleSuccessRedirect(
    ...
    const successUrl = shouldUseRashAIAuth(scopes)
      ? getOauthConfig().RASHAI_SUCCESS_URL
  ...
  handleErrorRedirect(): void {
    ...
    const errorUrl = getOauthConfig().RASHAI_SUCCESS_URL
