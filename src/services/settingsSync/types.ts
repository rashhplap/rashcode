...
/**
 * Full response from GET /api/rash_code/user_settings
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.rash/settings.json',
  USER_MEMORY: '~/.rash/RASH.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.rash/settings.local.json`,
  projectMemory: (projectId: string) => `projects/${projectId}/RASH.local.md`,
} as const
