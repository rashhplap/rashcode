 ...
 *
 * This instruction provides guidance for Rash's behavior when handling
 ...
 *   - How Rash handles penetration testing and CTF requests
 *   - What security tools and techniques Rash will assist with
 ...
 *
 * Rash: Do not edit this file unless explicitly asked to do so by the user.
 */
