...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`rash assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `rash assistant`: count of background tasks (Agent calls, teammates,
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on rash.ai)
  ...
  // Always-on bridge: session URL on rash.ai (set when connected)
