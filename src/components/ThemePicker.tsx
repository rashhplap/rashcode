...
export function ThemePicker(t0) {
  ...
  if ($[34] === Symbol.for("react.memo_cache_sentinel")) {
    t20 = {
      ...
      oldLines: 3,
      newLines: 3,
      lines: [" function greet() {", "-  console.log(\"Hello, World!\");", "+  console.log(\"Hello, Rash!\");", " }"]
    };
    $[34] = t20;
  } else {
    t20 = $[34];
