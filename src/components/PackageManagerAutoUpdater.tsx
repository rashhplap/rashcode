...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateCommand = packageManager === "homebrew" ? "brew upgrade rash-code" : packageManager === "winget" ? "winget upgrade Anthropic.RashCode" : packageManager === "apk" ? "apk upgrade rash-code" : "your package manager update command";
  let t4;
  if ($[3] !== verbose) {
