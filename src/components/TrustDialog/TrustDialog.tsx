...
export function TrustDialog(t0) {
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t18 = <Text>Rash Code{"'"}ll be able to read, edit, and execute files here.</Text>;
    $[20] = t16;
    $[21] = t17;
    $[22] = t18;
  } else {
  ...
  if ($[23] === Symbol.for("react.memo_cache_sentinel")) {
    t19 = <Text dimColor={true}><Link url="https://code.rash.com/docs/en/security">Security guide</Link></Text>;
    $[23] = t19;
  } else {
    t19 = $[23];
  }
