...
export type Props = {
   ...
   * project-scoped (written to the assistant's .rash/settings.json via
   * install.ts) and should not leak to the user's global ~/.rash/settings.
   */
...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between Rash models. Applies to this session and future Rash Code sessions. For other/previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
