...
export function McpParsingWarnings() {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Box flexDirection="column" marginTop={1} marginBottom={1}>{t4}<Box marginTop={1}><Text dimColor={true}>For help configuring MCP servers, see:{" "}<Link url="https://code.rash.com/docs/en/mcp">https://code.rash.com/docs/en/mcp</Link></Text></Box>{scopes.map(_temp5)}</Box>;
    $[5] = t5;
  } else {
    t5 = $[5];
  }
