...
export function TranscriptSharePrompt(t0) {
  ...
  if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box><Text color="ansi:cyan">{BLACK_CIRCLE} </Text><Text bold={true}>Can Anthropic look at your session transcript to help us improve Rash Code?</Text></Box>;
    $[6] = t3;
  } else {
    t3 = $[6];
  }
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Box marginLeft={2}><Text dimColor={true}>Learn more: https://code.rash.com/docs/en/data-usage#session-quality-surveys</Text></Box>;
    $[7] = t4;
  } else {
    t4 = $[7];
  }
