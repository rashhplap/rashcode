...
import { getRateLimitTier, getSubscriptionType, isRashAISubscriber } from 'src/utils/auth.js';
...
export function RateLimitMessage(t0) {
  ...
  const isMax20x = rateLimitTier === "default_rash_max_20x";
  let t3;
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = shouldProcessMockLimits() || isRashAISubscriber();
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  ...
  const isCurrentlyRateLimited = rashAiLimits.status === "rejected" && rashAiLimits.resetsAt !== undefined && !rashAiLimits.isUsingOverage;
  ...
  bb0: {
    ...
    if ($[7] !== shouldAutoOpenRateLimitOptionsMenu) {
      t7 = getUpsellMessage({
        ...
        isTeamOrEnterprise,
        hasBillingAccess: hasRashAiBillingAccess()
      });
