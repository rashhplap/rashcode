...
export function PreviewQuestionView({
  ...
  }, [isFooterFocused, footerIndex, isInPlanMode, isInNotesInput, focusedIndex, allOptions.length, handleUpFromFooter, handleDownFromPreview, handleNavigate, handleSelectOption, handleNotesExit, onRespondToRash, onFinishPlanInterview, onCancel, onTextInputFocus]);
