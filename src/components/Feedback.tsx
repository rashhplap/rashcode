...
const GITHUB_ISSUES_REPO_URL = "external" === 'ant' ? 'https://github.com/anthropics/rash-cli-internal/issues' : 'https://github.com/anthropics/rash-code/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Rash Code&apos;s functionality (eg. to reduce the risk of bugs
...
async function submitFeedback(data: FeedbackData, signal?: AbortSignal): Promise<{
  ...
  try {
    ...
    const response = await axios.post('https://api.anthropic.com/api/rash_cli_feedback', {
