...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.rash/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.rash/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.rash/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.rash/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.rash/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.rash/agent-memory-local/)",
      value: "local"
