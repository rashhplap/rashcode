...
// event/notch — users on those can set RASH_CODE_SCROLL_SPEED=3 to match
...
/** Read RASH_CODE_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set RASH_CODE_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.RASH_CODE_SCROLL_SPEED;
  if (!raw) return 1;
...
export function ScrollKeybindingHandler({
  ...
  // rash/jump-recent-message-CEPcq). getItemY Yoga-walk + computeOrigin +
