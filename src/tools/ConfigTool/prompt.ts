...
export const DESCRIPTION = 'Get or set Rash Code configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Rash Code configuration settings.

  View or change Rash Code settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.rash.json)
${globalSettings.join('\n')}
