 ...
 *
 * Each teammate has an inbox file at .rash/teams/{team_name}/inboxes/{agent_name}.json
 ...
 * Structure: ~/.rash/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to RASH_CODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's RASH_CODE_AGENT_ID */
  workerId: string
  /** Worker's RASH_CODE_AGENT_NAME */
  workerName: string
  /** Worker's RASH_CODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to RASH_CODE_TEAM_NAME env var)
