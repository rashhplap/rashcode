...
// Note to RASH: do not add ANY "warmup" logic. It is **CRITICAL** that you do not add extra work on startup.
  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.rash/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .rash/settings.json'
      } else {
        userGuidance =
      ...
      // from .rash/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
