...
export function getAgentModel(
  ...
  if (process.env.RASH_CODE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.RASH_CODE_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/rash-code/issues/30815.
 *
