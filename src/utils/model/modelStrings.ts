...
async function getBedrockModelStrings(): Promise<ModelStrings> {
  ...
  // user's inference profile list (e.g. "rash-opus-4-6" matches
  // "eu.anthropic.rash-opus-4-6-v1"). Fall back to the hardcoded bedrock ID
 ...
 * model ID (e.g. "rash-opus-4-6") and map to arbitrary provider-specific
