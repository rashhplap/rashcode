...
/**
 * The JSON Schema URL for Rash Code settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/rash-code-settings.json
 */
export const RASH_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/rash-code-settings.json'
