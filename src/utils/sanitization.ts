 ...
 *
 * The vulnerability was demonstrated in HackerOne report #3086545 targeting Rash Desktop's
 * MCP (Model Context Protocol) implementation, where attackers could inject hidden instructions
 * using Unicode Tag characters that would be executed by Rash but remain invisible to users.
 *
