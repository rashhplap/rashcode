 ...
 *
 * These helpers identify whether this Rash Code instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.RASH_CODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our RASH_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no RASH_CODE_AGENT_ID set (backwards compat: the original
