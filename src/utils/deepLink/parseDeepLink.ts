 ...
 *
 * Parses `rash-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   rash-cli://open
 *   rash-cli://open?q=hello+world
 *   rash-cli://open?q=fix+tests&repo=owner/repo
 *   rash-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'rash-cli'
 ...
 * the `cd /d <cwd> && <rash.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a rash-cli:// URI into a structured action.
 *
...
/**
 * Build a rash-cli:// deep link URL.
 */
