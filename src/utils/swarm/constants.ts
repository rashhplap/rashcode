...
export const SWARM_SESSION_NAME = 'rash-swarm'
export const SWARM_VIEW_WINDOW_NAME = 'swarm-view'
export const TMUX_COMMAND = 'tmux'
export const HIDDEN_SESSION_NAME = 'rash-hidden'
 ...
 * Includes PID to ensure multiple Rash instances don't conflict.
 */
export function getSwarmSocketName(): string {
  return `rash-swarm-${process.pid}`
}

/**
 * Environment variable to override the command used to spawn teammate instances.
 * If not set, defaults to process.execPath (the current Rash binary).
 * This allows customization for different environments or testing.
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'RASH_CODE_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'RASH_CODE_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'RASH_CODE_PLAN_MODE_REQUIRED'
