 ...
 * /home/rash/.rash/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/rash/.rash/remote'
 ...
 * access. CCR-gated: outside CCR there's no /home/rash/ and no reason to
 ...
 * rationale. Env var: RASH_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/rash/.rash/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'RASH_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: RASH_CODE_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/rash/.rash/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'RASH_CODE_API_KEY_FILE_DESCRIPTOR',
