...
import { queryModelWithoutStreaming } from '../../services/api/rash.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .rash/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.rash', 'skills', skillName, 'SKILL.md')
