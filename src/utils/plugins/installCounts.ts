 ...
 * Rash plugins statistics repository. The cache is refreshed if older
 * than 24 hours.
 *
 * Cache location: ~/.rash/plugins/install-counts-cache.json
 */
...
const INSTALL_COUNTS_URL =
  'https://raw.githubusercontent.com/anthropics/rash-plugins-official/refs/heads/stats/stats/plugin-installs.json'
