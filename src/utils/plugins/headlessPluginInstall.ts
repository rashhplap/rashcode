 ...
 *
 * When RASH_CODE_PLUGIN_USE_ZIP_CACHE is enabled, plugins are stored as
...
export async function installPluginsForHeadless(): Promise<boolean> {
  ...
  // Register seed marketplaces (RASH_CODE_PLUGIN_SEED_DIR) before diffing.
  ...
  // Declared now includes an implicit rash-plugins-official entry when any
  ...
  // which composes correctly with RASH_CODE_PLUGIN_SEED_DIR: seed registers
