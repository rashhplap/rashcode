...
export type Theme = {
  ...
  bashBorder: string
  rash: string
  rashShimmer: string // Lighter version of rash color for shimmer effect
  rashBlue_FOR_SYSTEM_SPINNER: string
  rashBlueShimmer_FOR_SYSTEM_SPINNER: string
  permission: string
...
const lightTheme: Theme = {
  ...
  rash: 'rgb(215,119,87)', // Rash orange
  rashShimmer: 'rgb(245,149,117)', // Lighter rash orange for shimmer effect
  rashBlue_FOR_SYSTEM_SPINNER: 'rgb(87,105,247)', // Medium blue for system spinner
  rashBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(117,135,255)', // Lighter blue for system spinner shimmer
  ...
  briefLabelRash: 'rgb(215,119,87)', // Brand orange
...
const lightAnsiTheme: Theme = {
  ...
  rash: 'ansi:redBright',
  rashShimmer: 'ansi:yellowBright',
  rashBlue_FOR_SYSTEM_SPINNER: 'ansi:blue',
  rashBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const darkAnsiTheme: Theme = {
  ...
  rash: 'ansi:redBright',
  rashShimmer: 'ansi:yellowBright',
  rashBlue_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  rashBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const lightDaltonizedTheme: Theme = {
  ...
  rash: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  rashShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  rashBlue_FOR_SYSTEM_SPINNER: 'rgb(51,102,255)', // Bright blue for system spinner
  rashBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(101,152,255)', // Lighter bright blue for system spinner shimmer
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelRash: 'rgb(255,153,51)', // Orange adjusted for deuteranopia (matches rash)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  rash: 'rgb(215,119,87)', // Rash orange
  rashShimmer: 'rgb(235,159,127)', // Lighter rash orange for shimmer effect
  rashBlue_FOR_SYSTEM_SPINNER: 'rgb(147,165,255)', // Blue for system spinner
  rashBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(177,195,255)', // Lighter blue for system spinner shimmer
...
const darkDaltonizedTheme: Theme = {
  ...
  rash: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  rashShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  rashBlue_FOR_SYSTEM_SPINNER: 'rgb(153,204,255)', // Light blue for system spinner
  rashBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(183,224,255)', // Lighter blue for system spinner shimmer
