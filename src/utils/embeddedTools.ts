 ...
 *
 * When true:
 * - `find` and `grep` in Rash's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering Rash away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.RASH_CODE_ENTRYPOINT
  return (
