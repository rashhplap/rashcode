...
import { trackRashInChromeTabId } from './common.js';
export type { Tool } from '@modelcontextprotocol/sdk/types.js';

/**
 * All tool names from BROWSER_TOOLS in @ant/rash-for-chrome-mcp.
...
/**
 * Renders a clickable "View Tab" link for Rash in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a Rash in Chrome MCP tool
...
/**
 * Custom tool result message rendering for rash-in-chrome tools.
...
/**
 * Returns tool method overrides for Rash in Chrome MCP tools. Use this to customize
 * rendering for chrome tools in a single spread operation.
 */
export function getRashInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `Rash in Chrome[${displayName}]`;
    },
