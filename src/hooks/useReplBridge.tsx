 ...
 *
 * Inbound messages from rash.ai are injected into the REPL via queuedCommands.
 */
    ...
    if (feature('BRIDGE_MODE')) {
      ...
      void (async () => {
        try {
          ...
          // Assistant mode: perpetual bridge session — rash.ai shows one
          ...
          // When a user message arrives from rash.ai, inject it into the REPL.
          ...
          const handle_0 = await initReplBridge({
            ...
            onSetPermissionMode(mode) {
              ...
              //     unchanged (3-way invariant violation per src/RASH.md)
          ...
          if (outboundOnly) {
            ...
            if (cancelled) return;
            setMessages(prev_18 => [...prev_18, createBridgeStatusMessage(url, upgradeNudge ? 'Please upgrade to the latest version of the Rash mobile app to see your Remote Control sessions.' : undefined)]);
