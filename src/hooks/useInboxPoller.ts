 ...
 * - Process-based teammates use their RASH_CODE_AGENT_NAME
...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for Rash (include color if available)
    // Transform plan approval requests to include instructions for Rash
