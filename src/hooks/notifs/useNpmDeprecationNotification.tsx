...
const NPM_DEPRECATION_MESSAGE = 'Rash Code has switched from npm to native installer. Run `rash install` or see https://docs.anthropic.com/en/docs/rash-code/getting-started for more options.';
