...
/**
 * Surfaces plugin-install prompts driven by `<rash-code-hint />` tags
 * that CLIs/SDKs emit to stderr. See docs/rash-code-hints.md.
 *
...
import { clearPendingHint, getPendingHintSnapshot, markShownThisSession, subscribeToPendingHint } from '../utils/rashCodeHints.js';
  ...
  if ($[0] !== pendingHint || $[1] !== tryResolve) {
    t0 = () => {
      ...
      tryResolve(async () => {
        ...
        if (resolved) {
          logForDebugging(`[useRashCodeHintRecommendation] surfacing ${resolved.pluginId} from ${resolved.sourceCommand}`);
