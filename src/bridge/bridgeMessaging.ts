...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so rash.ai sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so rash.ai doesn't show
