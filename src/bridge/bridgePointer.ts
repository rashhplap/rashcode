 ...
 * persists. On next startup, `rash remote-control` detects it and offers
 ...
 * and handles errors — no existence check (RASH.md TOCTOU rule). Returns
 ...
 * mutate to a worktree path — but `rash remote-control --continue` runs
