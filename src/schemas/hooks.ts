...
function buildHookSchemas() {
  ...
  const PromptHookSchema = z.object({
    ...
    model: z
      ...
      .optional()
      .describe(
        'Model to use for this prompt hook (e.g., "rash-sonnet-4-6"). If not specified, uses the default small fast model.',
      ),
    statusMessage: z
      .string()
      .optional()
  ...
  const AgentHookSchema = z.object({
    ...
    model: z
      ...
      .optional()
      .describe(
        'Model to use for this agent hook (e.g., "rash-sonnet-4-6"). If not specified, uses Haiku.',
      ),
    statusMessage: z
      .string()
      .optional()
