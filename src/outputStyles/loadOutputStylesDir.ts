...
/**
 * Loads markdown files from .rash/output-styles directories throughout the project
 * and from ~/.rash/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .rash/output-styles/*.md -> project styles
 * - User ~/.rash/output-styles/*.md -> user styles (overridden by project styles)
 *
