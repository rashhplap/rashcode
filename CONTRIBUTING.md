# Contributing to rashcode

Thanks for contributing.

rashcode is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/Rashhplap/rashcode/issues) and [discussions](https://github.com/Rashhplap/rashcode/discussions) before opening a new thread.
...
rashcode supports multiple provider paths. If you change provider logic:
